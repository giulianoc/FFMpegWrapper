...
void FFMpegWrapper::splitVideoInChunks(
...
// audio and video
void FFMpegWrapper::cutWithoutEncoding(
...
// only video
void FFMpegWrapper::cutFrameAccurateWithEncoding(
...
void FFMpegWrapper::extractTrackMediaToIngest(
